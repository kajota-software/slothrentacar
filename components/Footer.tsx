    ...
    <footer className="bg-forest-dark text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* Links */}
          <div>
            <h3 className="font-heading text-white font-semibold mb-4 text-sm uppercase tracking-wider">
              Links
            </h3>
            <ul className="space-y-2.5">
              {(
                [
                  ['/#fleet', t('links.fleet')],
                  ['/#how-it-works', t('links.howItWorks')],
                  ['/#faq', t('links.faq')],
                ] as const
              ).map(([href, label]) => (
                <li key={href}>
                  <a href={href} className="text-white/60 hover:text-amber text-sm transition-colors duration-200">
                    {label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <a
                  href="https://www.instagram.com/slothrentacar?igsh=aWd0YXdrdmV1Yzl6"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-white/60 hover:text-amber text-sm transition-colors duration-200"
                >
              ...
              <li>
                <a
                  href="https://www.facebook.com/share/1KZYGLBHLb/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-white/60 hover:text-amber text-sm transition-colors duration-200"
                >
